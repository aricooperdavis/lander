...
def play(screen, clock, difficulty, muted):
    ...
    class Planet(pygame.sprite.Sprite):
        ...
        def __init__(self):
            ...
            self.image = pygame.image.load("../resources/images/moon_surface.png").convert_alpha()
            #the image used for the planet surface
            self.bg_image = pygame.image.load("../resources/images/moon_long.png").convert_alpha()
            #the image used as a background for the planet (including planet surface)
            self.map = pygame.image.load("../resources/images/moon_map.png").convert_alpha()
