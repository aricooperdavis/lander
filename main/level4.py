...
def play(screen, clock, difficulty, muted):
    ...
    while in_level:
        ...
        while playing:
            ...
            x_vel_txt = font_small.render("Horizontal speed: "+str(round(random.random()*100, 1)), True, random.choice([GREEN, RED]))
            y_vel_txt = font_small.render("Vertical speed: "+str(round(random.random()*100, 1)), True, random.choice([GREEN, RED]))
