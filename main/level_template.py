...
def play(screen, clock, difficulty, muted):
    ...
    class Planet(pygame.sprite.Sprite):
        ...
        def __init__(self):
            ...
            self.bg_image = pygame.image.load("./resources/images/moon_long.png").convert_alpha() #CHANGE_ME
            #the image used as a background for the planet (including planet surface)
            self.map = pygame.image.load("./resources/images/moon_map.png").convert_alpha() #CHANGE_ME
    ...
    while in_level:
        ...
        while playing:
            ...
            #display the horizontal velocity text on the screen (in a place appropraite for the )
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_SPACE:
                    #check for the space key being pressed, which advances to the next level
                    player.c_position = (640, 360)
                    #reset the player position
                    player.velocities = (6, 6)
                    #reset the player velocity
